...
#
# Inputs:
#   /mnt/efs/home/ubuntu/endo-me_data/PCA_case_cycle_pre_post/pca_scores_pre.csv
#   /mnt/efs/home/ubuntu/endo-me_data/PCA_case_cycle_pre_post/pca_scores_post.csv
#   SH-Data Annotation_07.07.20_1.csv
#   R01_Study_IDs_to_include_220622.txt
#
# Outputs:
#   UMAP plots for:
#     - cycle phase
...
# Output directory
# -----------------------------
OUT_DIR <- "/mnt/efs/home/ubuntu/endo-me_data/UMAP_from_PCA"
...
rownames(pca_pre)  <- pca_pre[,1]
rownames(pca_post) <- pca_post[,1]
